...
class NEO(object):
    """ Near Earth Object retrieved from NEOWebService API """
...
class NEOWebService(object):
    ...
    def processNEOs(self, json_neo_list):
        """ Make a list of NEOs by calling 
            populate on near_earth_objects json data """
        neo_list = []
        for neo in json_neo_list:  # Process each NEO from response
    ...
    def fetch_all(self):
        ...
        neo_list = []
        initial_page = self.browse()  # initial_page = [neo_list, links]
